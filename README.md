...
Codex Security audit от 2026-05-11 пройден с исправлениями. Найденные issues закрыты и описаны в [docs/security/codex-security-audit-2026-05-11.md](docs/security/codex-security-audit-2026-05-11.md).
